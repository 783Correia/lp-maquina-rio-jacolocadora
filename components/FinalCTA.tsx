...
export default function FinalCTA() {
    return (
        <>
            {/* CTA Bar */}
            <section className="py-12 lg:py-16" style={{ backgroundColor: 'var(--surface-light)', borderTop: '3px solid var(--accent)' }}>
                <div className="max-w-6xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'var(--accent)' }}>
                        ...
                        <div>
                            <h3 className="text-xl sm:text-2xl font-bold" style={{ color: 'var(--text-dark)' }}>
                                Solicite seu orçamento
                            </h3>
                            <p className="text-sm" style={{ color: 'var(--text-dark-secondary)' }}>
                                Resposta rápida pelo WhatsApp. Atendemos todo o estado de SC.
                            </p>
                        </div>
                    </div>
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl font-bold text-white text-sm transition-all duration-300 hover:scale-[1.03] hover:shadow-lg flex-shrink-0"
            ...
            {/* Footer */}
            <footer className="py-6" style={{ backgroundColor: 'var(--surface-dark)' }}>
                <div className="max-w-6xl mx-auto px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <Image
                        src="https://jaco-locacao.vercel.app/logos/LOGO%20JAC%C3%93%20LOCA%C3%87%C3%83O.png"
                        alt="Jacó Locação"
                        width={120}
                        height={36}
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors">
